...
API_KEY = os.environ.get("PSD_API_KEY", "9B50B342-EA13-4269-BFC8-77E9E9903161")
...
def fetch_psd(commodity_code, market_year, retries=3, delay=15):
    """Fetch PSD data for a commodity and market year, with retry."""
    ...
    for attempt in range(1, retries + 1):
        try:
            ...
            if attempt < retries:
                ...
                print(f"    Failed after {retries} attempts for {commodity_code} MY{market_year}: {e}")
    return None
